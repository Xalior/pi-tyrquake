...
//     tyrquake-defaults.ld pins to image offset 0x800. It ships with the
...
#ifdef __ELF__
__asm__ (
    "\t.section .tyrquake.entry, \"ax\", %progbits\n"
    "\t.globl _tyrquake_entry\n"
    "_tyrquake_entry:\n"
    "\tb _start\n"
    "\t.previous\n"
);
#define DEFAULTS_BLOCK_PLACEMENT \
    __attribute__ ((section (".tyrquake.defaults"), used, aligned (8)))
#else
...
TDefaultsBlock _tyrquake_defaults =
{
